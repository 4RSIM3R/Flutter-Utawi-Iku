...
import 'package:utawi_iku/dashboard.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Please Login to your account to continue using Utawi Iku",
                    style: TextStyle(
                        fontFamily: "Regular",
                        fontSize: 16.0,
            ...
            Padding(
              padding: EdgeInsets.symmetric(vertical: 0.0, horizontal: 28.0),
              child: Container(
                width: double.infinity,
                height: 240.0,
                decoration:
